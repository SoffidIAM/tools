 ...
 * @version $Id: AbstractSarMojo.java,v 1.1 2008-05-20 12:22:51 u07286 Exp $
 */
    ...
    extends AbstractMojo
{
    ...
    protected static File getSarFile( File basedir, String finalName, String classifier )
    {
        if ( classifier == null )
        {
            classifier = "";
        ...
        return new File( basedir, finalName + classifier + ".sar" );
    }
    ...
    {
        File parFile = getSarFile( outputDirectory, finalName, getClassifier() );
