 ...
 */
public class MdaMojoTest
    extends AbstractMojoTestCase
{
    private File testPom = new File( getBasedir(), "src/test/resources/unit/mda-basic-test/pom.xml" );
     ...
     * @throws Exception
     */
    public void testMdaTestEnvironment()
        throws Exception
    {

        //File pom = new File( getBasedir(), "src/test/resources/unit/clean/pom.xml" );

        MdaMojo mojo = (MdaMojo) lookupMojo( "mda", testPom );
