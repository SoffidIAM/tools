...
@Service @Depends ({es.caib.seycon.ng.model.LlistaCorreuEntity.class,
...
public abstract class LlistesDeCorreuService {
	...
	translated="findUsersByMailListNameAndDomainCode")
	@Transactional(rollbackFor={java.lang.Exception.class})
	...
	translated="findExternalMailsByNameListAndDomainCode")
	@Transactional(rollbackFor={java.lang.Exception.class})
	...
	@Operation ( grantees={Roles.mail_create.class,Roles.user_create.class,Roles.user_update.class})
	@Transactional(rollbackFor={java.lang.Exception.class})
	...
	@Operation ( grantees={Roles.mail_query.class,Roles.user_update.class},
	translated="findUserMailListByListNameAndDomainCode")
	@Transactional(rollbackFor={java.lang.Exception.class})
	...
	@Operation ( grantees={Roles.mail_create.class,Roles.user_create.class,Roles.user_delete.class,Roles.user_update.class,Roles.mail_update.class})
	@Transactional(rollbackFor={java.lang.Exception.class})
	...
	@Operation ( grantees={Roles.mail_delete.class,Roles.user_delete.class,Roles.mail_update.class})
	@Transactional(rollbackFor={java.lang.Exception.class})
	public void delete(
		es.caib.seycon.ng.comu.LlistaCorreuUsuari llistaCorreuUsuari)
		throws es.caib.seycon.ng.exception.InternalErrorException {
	...
	@Operation ( grantees={Roles.mail_query.class,Roles.user_create.class,Roles.user_delete.class,Roles.user_update.class},
	translated="findUserMailListByListNameAndDomainCodeAndUserCode")
	@Transactional(rollbackFor={java.lang.Exception.class})
	...
	@Operation ( grantees={Roles.mail_query.class,Roles.user_delete.class},
	translated="findUserMailListByUserCode")
	@Transactional(rollbackFor={java.lang.Exception.class})
	...
	@Operation ( grantees={Roles.mail_query.class},
	translated="findMailDomainByCode")
	@Transactional(rollbackFor={java.lang.Exception.class})
	...
	@Operation ( grantees={Roles.mail_query.class},
	translated="findRelationsMailListByNameAndBelongsMailListCodeAndNameAndContainsMailListCode")
	@Transactional(rollbackFor={java.lang.Exception.class})
	...
	@Operation ( grantees={Roles.mail_query.class,Roles.user_update.class},
	translated="findRelationsMailListByNameBelongsMailListAndDomainCode")
	@Transactional(rollbackFor={java.lang.Exception.class})
	...
	@Operation ( grantees={Roles.mail_query.class,Roles.user_update.class},
	translated="findRelationsMailListByNameContainsMailListAndDomainCode")
	@Transactional(rollbackFor={java.lang.Exception.class})
	...
	@Operation ( grantees={Roles.mail_query.class,Roles.user_create.class,Roles.user_update.class},
	translated="findMailListByNameAndDomainCode")
	@Transactional(rollbackFor={java.lang.Exception.class})
